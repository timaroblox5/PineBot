...
const { MessageComponentTypes } = require("./src/Constants")
const Modal = require("./src/structures/Modal");
...
module.exports = (client) => {
    ...
    client.ws.on("INTERACTION_CREATE", (data) => {
      ...
      switch (data.data.component_type) {
        case MessageComponentTypes.MODAL:
          client.emit("modalSubmit", new Modal(data, client));
          break;
